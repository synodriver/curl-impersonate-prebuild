...
if(NOT TARGET CURL::libcurl-impersonate)
  ...
  add_library(CURL::libcurl-impersonate ALIAS CURL::libcurl_shared)
endif()

# For compatibility with CMake's FindCURL.cmake
set(CURL_VERSION_STRING "8.15.0-IMPERSONATE")
set(CURL_LIBRARIES CURL::libcurl-impersonate)
...
set(CURL_SUPPORTED_FEATURES "alt-svc;AsynchDNS;brotli;ECH;HSTS;HTTP2;HTTP3;HTTPS-proxy;HTTPSRR;IDN;IPv6;Largefile;libz;NTLM;SSL;SSLS-EXPORT;threadsafe;Unicode;UnixSockets;zstd")
